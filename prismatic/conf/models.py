...
class ModelConfig(ChoiceRegistry):
    ...
    image_sequence_len: int = 1                             # Number of images/frames per visual sample
...
@dataclass
class Prism_Qwen25_0_5B_Extra_VJEPA21_384px(Prism_Qwen25_0_5B_VJEPA21_384px):
    model_id: str = "prism-qwen25-extra-vjepa21-384px+0_5b"
    llm_backbone_id: str = "qwen25-0_5b-extra"
...
@dataclass
class Prism_Qwen25_0_5B_VJEPA21_ViTG_384px_FusedFAN(Prism_Qwen25_0_5B_VJEPA21_ViTG_384px):
    model_id: str = "prism-qwen25-vjepa21-vitg-384px+0_5b+fusedfan-projector"
    arch_specifier: str = "no-align+fusedfan-projector"
...
@dataclass
class Prism_Qwen25_0_5B_JEPASigLIP_384px(Prism_Qwen25_0_5B_VJEPA21_384px):
    model_id: str = "prism-jepasiglip+0_5b"
    vision_backbone_id: str = "jepasiglip-vit-l-so-384px"
    arch_specifier: str = "no-align+fused-gelu-mlp"
...
@dataclass
class Prism_Qwen3_1_7B_VJEPA21_384px(Exp_7B_One_Stage):
    model_id: str = "prism-qwen3-vjepa21-384px+1_7b"
    vision_backbone_id: str = "vjepa2_1-vit-l-384px"
    image_resize_strategy: str = "resize-naive"
    llm_backbone_id: str = "qwen3-1_7b-pure"
    arch_specifier: str = "no-align+gelu-mlp"
    finetune_epochs: int = 2
...
@dataclass
class Prism_Qwen3_1_7B_VJEPA21_ViTB_384px(Prism_Qwen3_1_7B_VJEPA21_384px):
    model_id: str = "prism-qwen3-vjepa21-vitb-384px+1_7b"
    vision_backbone_id: str = "vjepa2_1-vit-b-384px"


@dataclass
class Prism_Qwen3_1_7B_VJEPA21_ViTL_384px(Prism_Qwen3_1_7B_VJEPA21_384px):
    model_id: str = "prism-qwen3-vjepa21-vitl-384px+1_7b"
    vision_backbone_id: str = "vjepa2_1-vit-l-384px"


@dataclass
class Prism_Qwen3_1_7B_VJEPA21_ViTG_384px(Prism_Qwen3_1_7B_VJEPA21_384px):
    model_id: str = "prism-qwen3-vjepa21-vitg-384px+1_7b"
    vision_backbone_id: str = "vjepa2_1-vit-g-384px"


@dataclass
class Prism_Qwen3_1_7B_VJEPA21_ViTGigantic_384px(Prism_Qwen3_1_7B_VJEPA21_384px):
    model_id: str = "prism-qwen3-vjepa21-vitG-384px+1_7b"
    vision_backbone_id: str = "vjepa2_1-vit-G-384px"
...
class ModelRegistry(Enum):
    ...
    PRISM_QWEN25_VJEPA21_VITG_384PX_0_5B_FUSEDFAN = Prism_Qwen25_0_5B_VJEPA21_ViTG_384px_FusedFAN
    ...
    PRISM_QWEN3_VJEPA21_384PX_1_7B = Prism_Qwen3_1_7B_VJEPA21_384px
    PRISM_QWEN3_VJEPA21_VITB_384PX_1_7B = Prism_Qwen3_1_7B_VJEPA21_ViTB_384px
    PRISM_QWEN3_VJEPA21_VITL_384PX_1_7B = Prism_Qwen3_1_7B_VJEPA21_ViTL_384px
    PRISM_QWEN3_VJEPA21_VITG_384PX_1_7B = Prism_Qwen3_1_7B_VJEPA21_ViTG_384px
    PRISM_QWEN3_VJEPA21_VITGIGANTIC_384PX_1_7B = Prism_Qwen3_1_7B_VJEPA21_ViTGigantic_384px
